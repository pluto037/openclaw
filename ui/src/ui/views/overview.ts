...
export function renderOverview(props: OverviewProps) {
  ...
  const authHint = (() => {
    ...
    return html`
      <div class="muted" style="margin-top: 8px;">
        认证失败。请使用 <span class="mono">openclaw dashboard --no-open</span> 重新复制带 Token 的 URL，或者更新 Token，然后点击连接。
        <div style="margin-top: 6px;">
          <a
            class="session-link"
            href="https://docs.openclaw.ai/web/dashboard"
  ...
  const insecureContextHint = (() => {
    ...
    return html`
      <div class="muted" style="margin-top: 8px;">
        当前页面为 HTTP，浏览器阻止了设备标识。请使用 HTTPS (Tailscale Serve) 或在网关主机上打开 <span class="mono">http://127.0.0.1:18789</span>。
        <div style="margin-top: 6px;">
          如果您必须使用 HTTP，请设置
          <span class="mono">gateway.controlUi.allowInsecureAuth: true</span> (仅 Token)。
        </div>
        <div style="margin-top: 6px;">
          <a
            class="session-link"
      ...
      <div class="card">
        ...
        ${props.lastError
          ...
          : html`<div class="callout" style="margin-top: 14px;">
              使用频道功能连接 WhatsApp, Telegram, Discord, Signal 或 iMessage。
            </div>`}
      </div>
    </section>
    ...
    <section class="card" style="margin-top: 18px;">
      ...
      <div class="note-grid" style="margin-top: 14px;">
        <div>
          ...
          <div class="muted">
            推荐使用 serve 模式，将网关保持在 loopback 并配合 tailnet 认证。
          </div>
        </div>
        <div>
        ...
        <div>
          ...
          <div class="muted">为周期性运行使用隔离的会话。</div>
        </div>
      </div>
    </section>
  `;
